...
export const ConsentFormEcoTv = ({ patientData, onBack }: ConsentFormProps) => {
  ...
  const generatePDF = async (): Promise<Blob> => {
    ...
    try {
      ...
      const { generateEcoTvPDF } = await import('@/utils/pdfGeneratorEcoTv');
      ...
      const pdf = await generateEcoTvPDF(pdfData);
  ...
  return (
    <ConsentFormWrapper
      consentType="ULTRASONIDO TRANSVAGINAL"
      consentTypeCode="eco_tv"
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <CardTitle className="text-medical-blue text-xl">
                  Consentimiento Informado - Ultrasonido Transvaginal
                </CardTitle>
                <p className="text-medical-gray text-sm mt-1">
                  Formato 35 - Complete todos los campos requeridos para generar el consentimiento
                </p>
              </div>
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-medical-blue">
                Procedimiento de Ultrasonido Transvaginal
              </CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              >
                <Checkbox
                  id="procedimiento-eco_tv"
                  checked={selectedProcedures.includes("eco_tv")}
                  onCheckedChange={(checked) => {
                    if (checked) {
                      handleProcedureChange("eco_tv");
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-medical-gray mt-1">
                    La ecografía o ultrasonido transvaginal es un estudio de diagnóstico por imágenes de alta resolución que utiliza ondas sonoras de alta frecuencia (ultrasonido) para la evaluación morfológica y hemodinámica de los.
                  </p>
                </div>
              </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="border-l-4 border-green-500 bg-green-50 p-4 rounded-r-lg">
                        ...
                        <p className="text-sm text-gray-700">
                          1. Definición anatómica superior de la mucosa endometrial, reserva folicular y vascularización pélvica mediante Doppler. 2. Examen completamente inocuo para la paciente y, en caso de embarazo temprano, para el embrión. 3. Diagnóstico inmediato sin requerir preparación con vejiga llena
                        </p>
                      </div>
                      ...
                      <div className="border-l-4 border-orange-500 bg-orange-50 p-4 rounded-r-lg">
                        ...
                        <p className="text-sm text-gray-700">
                          Puede generar incomodidad, ansiedad, pudor o dolor; la paciente puede informar estas sensaciones Pueden identificarse hallazgos incidentales o indeterminados que requieran seguimiento, valoración médica o estudios adicionales; el ultrasonido por sí solo no siempre establece un diagnóstico definitivo
                        </p>
                      </div>
                      ...
                      <div className="border-l-4 border-yellow-500 bg-yellow-50 p-4 rounded-r-lg">
                        ...
                        <p className="text-sm text-gray-700">
                          1. Sensación de presión o molestia transitoria introducida por la manipulación y rotación manual del transductor para la alineación de los planos de corte anatómicos. 2. Restos de gel lubricante hidrosoluble en la zona vulvovaginal tras la extracción del transductor.
                        </p>
                      </div>
                      ...
                      <div className="border-l-4 border-gray-500 bg-gray-50 p-4 rounded-r-lg">
                        ...
                        <p className="text-sm text-gray-700">
                          - Diagnóstico impreciso o tardío - Retraso en la detección de complicaciones de embarazo inicial - Progresión de patologías pélvicas
                        </p>
                      </div>
          ...
          <CardContent>
            ...
            <div className="bg-medical-blue-light/20 border border-medical-blue/20 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                />
                <Label htmlFor="consent-eco_tv" className="cursor-pointer text-medical-gray text-sm leading-relaxed">
