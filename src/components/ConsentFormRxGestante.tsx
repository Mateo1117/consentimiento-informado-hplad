...
export const ConsentFormRxGestante = ({ patientData, onBack }: ConsentFormProps) => {
  ...
  const generatePDF = async (): Promise<Blob> => {
    ...
    try {
      ...
      const { generateRxGestantePDF } = await import('@/utils/pdfGeneratorRxGestante');
      ...
      const pdf = await generateRxGestantePDF(pdfData);
  ...
  return (
    <ConsentFormWrapper
      consentType="TOMA DE RADIOGRAFÍA PARA GESTANTE"
      consentTypeCode="rx_gestante"
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <CardTitle className="text-medical-blue text-xl">
                  Consentimiento Informado - Radiografía para Gestante
                </CardTitle>
                <p className="text-medical-gray text-sm mt-1">
                  Formato 32 - Complete todos los campos requeridos para generar el consentimiento
                </p>
              </div>
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center gap-3">
              ...
              <CardTitle className="text-medical-blue">
                Procedimiento de Radiografía para Gestante
              </CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <div className="space-y-4">
              ...
              >
                <Checkbox
                  id="procedimiento-rx_gestante"
                  checked={selectedProcedures.includes("rx_gestante")}
                  onCheckedChange={(checked) => {
                    if (checked) {
                      handleProcedureChange("rx_gestante");
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-medical-gray mt-1">
                    La toma de radiografía en la paciente gestante es un estudio de diagnóstico por imágenes que utiliza dosis extremadamente bajas de radiación ionizante (rayos X) para la evaluación de estructuras óseas, articulares,.
                  </p>
                </div>
              </div>
                  ...
                  <div className="bg-medical-blue-light/10 p-6 rounded-lg border border-medical-blue-light/20">
                    <div className="space-y-4">
                      ...
                      <div className="border-l-4 border-purple-500 bg-purple-50 p-4 rounded-r-lg">
                        ...
                        <p className="text-sm text-gray-700">
                          - Ultrasonido (Ecografía). Método de primera elección, totalmente libre de radiación ionizante - Resonancia Magnética (sin contraste). Opción diagnóstica de alta resolución para tejidos blandos y caracterización compleja que no utiliza radiación ionizante (no disponible).
                        </p>
                      </div>
                      ...
                      <div className="border-l-4 border-orange-500 bg-orange-50 p-4 rounded-r-lg">
                        ...
                        <p className="text-sm text-gray-700">
                          Requerimiento de colaboración activa del paciente en el posicionamiento e inmovilización momentánea para evitar la repetición de tomas. 2. Uso obligatorio de elementos de protección plomada (delantal/protector pélvico) sobre las zonas no objeto de estudio para la salvaguarda fetal. 3. Aceptación razonada de que el beneficio diagnóstico materno justifica el riesgo teórico mínimo de la radiación ionizante aplicada.
                        </p>
                      </div>
                      ...
                      <div className="border-l-4 border-yellow-500 bg-yellow-50 p-4 rounded-r-lg">
                        ...
                        <p className="text-sm text-gray-700">
                          1. Molestia postural 2. Miedo o ansiedad materna
                        </p>
                      </div>
                      ...
                      <div className="border-l-4 border-gray-500 bg-gray-50 p-4 rounded-r-lg">
                        ...
                        <p className="text-sm text-gray-700">
                          - Omisión de patología materna grave - Efectos secundarios indirectos en el feto - Necesidad de procedimientos invasivos alternativos
                        </p>
                      </div>
          ...
          <CardContent>
            ...
            <div className="bg-medical-blue-light/20 border border-medical-blue/20 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                />
                <Label htmlFor="consent-rx_gestante" className="cursor-pointer text-medical-gray text-sm leading-relaxed">
