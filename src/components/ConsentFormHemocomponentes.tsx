...
export const ConsentFormHemocomponentes = ({
  ...
  return (
    <ConsentFormWrapper
      ...
      consentTypeCode="hemocomponentes"
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-medical-gray text-sm mt-1">
                  Formato 320 - Complete todos los campos requeridos para generar el consentimiento
                </p>
              </div>
              ...
              >
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-medical-gray mt-1">
                    Es el trasplante de un tejido líquido, la sangre. Se realiza a través de la administración intravenosa de cualquiera de sus componentes.
                  </p>
                </div>
              </div>
