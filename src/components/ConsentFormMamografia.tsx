...
export const ConsentFormMamografia = ({ patientData, onBack }: ConsentFormProps) => {
  ...
  const generatePDF = async (): Promise<Blob> => {
    ...
    try {
      ...
      const { generateMamografiaPDF } = await import('@/utils/pdfGeneratorMamografia');
      ...
      const pdf = await generateMamografiaPDF(pdfData);
  ...
  return (
    <ConsentFormWrapper
      consentType="TOMA DE MAMOGRAFÍA"
      consentTypeCode="mamografia"
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                <CardTitle className="text-medical-blue text-xl">
                  Consentimiento Informado - Mamografía
                </CardTitle>
                <p className="text-medical-gray text-sm mt-1">
                  Formato 33 - Complete todos los campos requeridos para generar el consentimiento
                </p>
              </div>
        ...
        <Card className="border-medical-blue/20">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              >
                <Checkbox
                  id="procedimiento-mamografia"
                  checked={selectedProcedures.includes("mamografia")}
                  onCheckedChange={(checked) => {
                    if (checked) {
                      handleProcedureChange("mamografia");
                ...
                <div className="flex-1">
                  <Label
                    htmlFor="procedimiento-mamografia"
                  ...
                  <p className="text-sm text-medical-gray mt-1">
                    La mamografía es un estudio radiológico especializado para la evaluación del tejido mamario.
                  </p>
                </div>
              </div>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="border-l-4 border-blue-500 bg-blue-50 p-4 rounded-r-lg">
                        ...
                        <p className="text-sm text-gray-700 mb-3">
                          La mamografía es un estudio radiológico especializado para la evaluación del tejido mamario. La paciente se ubicará de pie frente al mamógrafo. La mama se posiciona sobre una plataforma plana y se comprime gradualmente mediante una paleta plástica durante unos segundos para homogenizar el grosor del tejido, reducir la dosis de radiación y optimizar la nitidez de la imagen. Se toman habitualmente dos proyecciones estándar por cada mama (craneocaudal y mediolateral oblicua).
                        </p>
                        <div className="bg-blue-100 p-3 rounded">
                          <p className="text-sm font-medium text-blue-800">
                            <strong>Propósito:</strong> Detección temprana de lesiones no palpables y caracterización de hallazgos clínicos o radiológicos en la glándula mamaria.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="border-l-4 border-gray-500 bg-gray-50 p-4 rounded-r-lg">
                        ...
                        <p className="text-sm text-gray-700">
                          Diagnóstico tardío Progresión de la enfermedad Requerimiento de tratamientos más invasivos Menor tasa de supervivencia Pérdida de la ventana de oportunidad terapéutica
                        </p>
                      </div>
          ...
          <CardContent>
            ...
            <div className="bg-medical-blue-light/20 border border-medical-blue/20 rounded-lg p-4">
              <div className="flex items-start gap-3">
                ...
                />
                <Label htmlFor="consent-mamografia" className="cursor-pointer text-medical-gray text-sm leading-relaxed">
