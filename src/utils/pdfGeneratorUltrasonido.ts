...
const ULTRASONIDO_PROCEDURE_DATA: BasePDFProcedureItem[] = [
  ...
  },
  {
    ...
    value: '- Sensación de frío y humedad - Presión mecánica sobre la zona examinada'
  },
  {
    label: 'ALTERNATIVAS RAZONABLES A ESTE PROCEDIMIENTO',
    value: '1. Tomografía Axial Computarizada (TAC). Se indica cuando se requiere evaluar estructuras óseas, retroperitoneo o cuando el gas intestinal invalida el ultrasonido. Utiliza radiación ionizante. 2. Resonancia Magnética (RM): Alternativa para una caracterización tisular de mayor definición en tejidos blandos y articulaciones, sin uso de radiación ionizante pero de menor disponibilidad inmediata. 3. Radiografía convencional.'
  },
  {
    label: 'POSIBLES CONSECUENCIAS EN CASO QUE DECIDA NO ACEPTAR EL PROCEDIMIENTO',
    value: '- Omisión o retraso diagnóstico - Progresión de cuadros agudos: Riesgo de evolución hacia complicaciones mayores - Requerimiento diferido de estudios invasivos'
  },
  {
